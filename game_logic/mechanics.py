...
async def get_main_text_row(user_id):
    ...
    row3 = "Faction: {faction}\n\nShip Stats:\nHP: {current_health}/{max_health},\nmain_quest: {main_quest}\nside_quest: {side_quest}\n\n{money_bag}Credits: {player_credits}{bar_chart}Exploration Data: {experience}\n{}Ship AI Level : {level}".format(
        faction=faction, current_health=current_health, max_health=max_health, main_quest=main_quest, side_quest=side_quest, money_bag=money_bag, bar_chart=bar_chart,
        experience=experience, level=level, player_credits=player_credits
    )
